...
@section('page-content')
    ...
    <section class="breadcrumb py-5 bg-color-primary justify-content-center rounded-0">
        <h2 class="text-center text-uppercase text-light display-4 d-flex flex-column"><i class="fas fa-book"></i>
            Course details</h2>
    </section>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h1 class="display-5 text-uppercase text-center color-primary mb-5">{{$course_details->course_full_name}}</h1>
                            </div>
                            <div class="col-md-12">
                                <p class=""><strong>Course Name :</strong>   {{ $course_details->course_name }}</p>
                                <p class=""><strong>Course Fee :</strong>    {{ $course_details->course_fee }}</p>
                                <p class=""><strong>Course Duration :</strong>   {{ $course_details->course_duration }}</p>
                                <p class=""><strong>Course Intake :</strong> {{ $course_details->intake }}</p>
                            </div>
