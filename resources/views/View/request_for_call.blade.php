...
@section('page-content')
    ...
    <section class="breadcrumb py-5 bg-color-primary justify-content-center rounded-0">
        <h2 class="text-center text-uppercase text-light display-4 d-flex flex-column"><i class="fas fa-mobile"></i>
            Request to call back</h2>
    </section>
    ...
    <section class="institutes mb-5">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h1 class="display-5 color-primary mb-2">{{ "Request to call back" }}</h1>
