                                    ...
                                    @if(!empty($categories))
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-simple btn-warning btn-icon edit" data-toggle="modal" data-body="{{ "blogcategorie" }}" data-id="{{ $category->id }}" data-target="#Modal"><i class="ti-pencil-alt"></i></a>
                                                    <a href="" class="btn btn-simple btn-info btn-icon del_brand remove" data-id="{{ $category->id }}" data-body="{{ "blogcategorie" }}"  ><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
    ...
    <div class="modal fade" id="Modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="{{ url('blogcategories') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row" style="padding: 10px">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="category_description" id="category_description" type="text" ></textarea>
                            </div>
