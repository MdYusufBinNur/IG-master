    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="card">
                        <form id="registerFormValidation" action="{{ url('universities') }}" method="post" enctype="multipart/form-data">
                            @csrf()
                            <div class="card-header">
                                <a href="{{ url('universities') }}" class="btn btn-outline-dark  pull-right">List</a>
                            ...
                            <div class="card-content">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="university_link">
                                        University Link
                                    </label>

                                    <input class="form-control" type="text" name="university_link" id="university_link" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="university_image" class="form-control" required/>
                                </div>
