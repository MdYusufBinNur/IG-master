                                    ...
                                    @if(!empty($applicants))
                                        @foreach($applicants as $applicant)
                                            <tr>
                                                ...
                                                <td class="text-center">{!! $applicant->qualification !!}</td>


                                                <td class="text-center">

                                                    <a href="#" class="btn btn-simple btn-success btn-icon edit" data-toggle="modal" data-id="{{ $applicant->id }}" data-body="req_to_callback"  data-target="#Modal"><i class="ti-eye"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                    ...
                    <div class="modal-body">
                        <div class="row" style="padding: 10px">
                            ...
                            <div class="form-group text-center">
                                <strong> <h4 id="applicant_name"></h4> </strong>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="{{ asset('') }}" alt="" width="100" height="auto" id="applicant_image">
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <p id="applicant_email"></p>
                                        <p id="applicant_mobile"> </p>
                                    </div>
                                </div>
                            </div>
