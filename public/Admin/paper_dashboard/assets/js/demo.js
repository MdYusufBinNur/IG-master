...
function get_university(id)
{
    ...
    let country_id = id.value;
    $("#university_id").find('option').remove().end();
    $("#university_id").find('option>selected').remove().end();
    $("#program_id").find('option').remove().end();
    $("#program_id").find('option>selected').remove().end();
    $(".sub_class ul.inner").empty();

    $.ajax(
        {
            url: '/university/'+country_id,
            method: 'get',
            ...
            success: function (result) {
                ...
                {
                    let value = resp.id;
                    let university = resp.university_name;
                    $("#university_id").append("<option  value="+ value +"  > "+university+" </option>");
    ...
    $.ajax(
        {
            ...
            success: function (result) {
                ...
                {
                    let value = resp.id;
                    let program = resp.program_name;
                    $("#program_id").append("<option  value="+ value +"  > "+program+" </option>");
